export const id_Attributes_TransactionID = '2.16.840.1.113733.1.9.7'; // {id-attributes transactionID(7)}
export const id_Attributes_MessageType = '2.16.840.1.113733.1.9.2'; // {id-attributes messageType(2)}
export const id_Attributes_PkiStatus = '2.16.840.1.113733.1.9.3'; // {id-attributes pkiStatus(3)}
